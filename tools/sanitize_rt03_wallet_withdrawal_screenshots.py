...
def main() -> None:
    """生成 RT-03-026 钱包提现候选、余额和流水的脱敏证据。"""

    stack_regions(
        "rt03-wallet-withdrawal-dropdown-reopened.png",
        "rt03-wallet-withdrawal-destination-dropdown-sanitized.png",
        [(0, 0, 222, 64)],
    )
    stack_regions(
        "rt03-wallet-withdrawal-filled-private.png",
        "rt03-wallet-withdrawal-filled-sanitized.png",
        [(0, 0, 714, 354)],
    )
    stack_regions(
        "rt03-wallet-withdrawal-wallet-after-restart-private.png",
    ...
    stack_regions(
        "rt03-wallet-withdrawal-balances-after-restart-private.png",
    ...
    stack_regions(
        "rt03-wallet-withdrawal-financial-record-after-restart-private.png",
