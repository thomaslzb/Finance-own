...
def stack_regions(
    ...
    """仅拼接本次钱包提现手续费相关区域，避免保留其它账户和历史流水。"""
...
def main() -> None:
    """生成 RT-03-026 钱包提现手续费输入、余额和流水的脱敏证据。"""

    stack_regions(
        "rt03-wallet-withdrawal-fee-destination-dropdown-private.png",
        "rt03-wallet-withdrawal-fee-destination-dropdown-sanitized.png",
        [(0, 0, 222, 64)],
    )
    stack_regions(
        "rt03-wallet-withdrawal-fee-filled-private.png",
        "rt03-wallet-withdrawal-fee-filled-sanitized.png",
        [(0, 0, 714, 354)],
    )
    stack_regions(
        "rt03-wallet-withdrawal-fee-wallet-after-restart-private.png",
    ...
    stack_regions(
        "rt03-wallet-withdrawal-fee-balances-after-restart-private.png",
    ...
    stack_regions(
        "rt03-wallet-withdrawal-fee-financial-record-after-restart-private.png",
