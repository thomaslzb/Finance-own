...
def main() -> None:
    """生成提现保存并继续、编辑取消和删除分支的脱敏证据。"""

    dialog_files = [
        "rt03-wallet-withdrawal-continuation-filled.png",
        "rt03-wallet-withdrawal-continuation-after-save.png",
        "rt03-wallet-withdrawal-continuation-edit-before-cancel.png",
        "rt03-wallet-withdrawal-continuation-edit-cancel-filled.png",
        "rt03-wallet-withdrawal-continuation-delete-no-confirmation.png",
    ]
    ...
    wallet_files = [
        "rt03-wallet-withdrawal-continuation-after-save-wallet.png",
        "rt03-wallet-withdrawal-continuation-after-edit-cancel-wallet.png",
        "rt03-wallet-withdrawal-continuation-after-delete-no-wallet.png",
        "rt03-wallet-withdrawal-continuation-after-delete-yes-wallet.png",
        "rt03-wallet-withdrawal-continuation-cold-restart-deleted-wallet.png",
    ]
