...
def main() -> None:
    """生成 RT-03-026 钱包充值候选、余额和流水的脱敏证据。"""

    stack_regions(
        "rt03-wallet-recharge-source-dropdown-private.png",
        "rt03-wallet-recharge-source-dropdown-sanitized.png",
        [(0, 0, 222, 64)],
    )
    stack_regions(
        "rt03-wallet-recharge-wallet-after-restart-raw.png",
    ...
    stack_regions(
        "rt03-wallet-recharge-balances-after-restart-raw.png",
    ...
    stack_regions(
        "rt03-wallet-recharge-global-after-restart-raw.png",
